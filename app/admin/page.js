...
const stats = [
    ...
    },
    {
        ...
        changeType: 'positive',
        icon: Trash2,
        description: 'Across 15 campuses',
    },
];
const weeklyActivityData = [
    { day: 'Mon', challenges: 245, binUsage: 180 },
    { day: 'Tue', challenges: 312, binUsage: 210 },
    { day: 'Wed', challenges: 287, binUsage: 195 },
    { day: 'Thu', challenges: 356, binUsage: 245 },
    { day: 'Fri', challenges: 298, binUsage: 220 },
    { day: 'Sat', challenges: 189, binUsage: 145 },
    { day: 'Sun', challenges: 167, binUsage: 130 },
];
const wasteTypeData = [
...
const recentSubmissions = [
    { id: 1, user: 'Tshering Dorji', challenge: 'Plastic Recycling', status: 'pending', time: '5 min ago' },
    { id: 2, user: 'Karma Wangmo', challenge: 'Composting', status: 'approved', time: '12 min ago' },
    { id: 3, user: 'Pema Gyalpo', challenge: 'Paper Collection', status: 'pending', time: '18 min ago' },
    { id: 4, user: 'Sonam Choden', challenge: 'Zero Waste Day', status: 'rejected', time: '25 min ago' },
    { id: 5, user: 'Dorji Wangchuk', challenge: 'Smart Bin Usage', status: 'approved', time: '32 min ago' },
];
const binAlerts = [
    { id: 1, name: 'CST Block A', fillLevel: 92, status: 'critical' },
    { id: 2, name: 'RTC Library', fillLevel: 85, status: 'warning' },
    { id: 3, name: 'JNEC Canteen', fillLevel: 78, status: 'warning' },
];
export default function AdminDashboardPage() {
    return (<div className="space-y-6">
      {/* Stats Grid */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, index) => (<motion.div key={stat.title} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }}>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      {stat.changeType === 'positive' ? (<ArrowUpRight className="w-4 h-4 text-chart-5"/>) : (<ArrowDownRight className="w-4 h-4 text-destructive"/>)}
        ...
        <Card className="border-border/50">
          ...
          <CardContent>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-4">
              {wasteTypeData.map((entry) => (<div key={entry.name} className="flex items-center gap-2">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="border-border/50">
          ...
          <CardContent>
            <div className="space-y-4">
              {recentSubmissions.map((submission) => (<div key={submission.id} className="flex items-center justify-between py-2 border-b border-border/50 last:border-0">
                  ...
                  <div className="flex items-center gap-3">
                    <span className={`text-xs px-2 py-1 rounded-full ${submission.status === 'approved' ? 'bg-chart-5/10 text-chart-5' :
        ...
        <Card className="border-border/50">
          ...
          <CardContent>
            <div className="space-y-4">
              {binAlerts.map((bin) => (<div key={bin.id} className={`p-4 rounded-lg border ${bin.status === 'critical' ? 'border-destructive/50 bg-destructive/5' : 'border-accent/50 bg-accent/5'}`}>
